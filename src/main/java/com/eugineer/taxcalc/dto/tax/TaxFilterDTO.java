...
public class TaxFilterDTO {
    ...
    public String toString () {
        return "TaxFilterDTO{" + "period=" + period + ", incomeFrom=" + incomeFrom + ", incomeTo=" + incomeTo + ", outOfRealizedIncomeWithoutVatFrom=" + outOfRealizedIncomeWithoutVatFrom + ", outOfRealizedIncomeWithoutVatTo=" + outOfRealizedIncomeWithoutVatTo + ", isHasMainWork=" + isHasMainWork + ", isBenefitPermitted=" + isBenefitPermitted + ", hasBenefitForSingle=" + hasBenefitForSingle + ", childrenYounger18From=" + childrenYounger18From + ", childrenYounger18To=" + childrenYounger18To + ", disabledChildrenFrom=" + disabledChildrenFrom + ", disabledChildrenTo=" + disabledChildrenTo + ", dependantsFrom=" + dependantsFrom + ", dependantsTo=" + dependantsTo + ", outcomeSumForInsuranceFrom=" + outcomeSumForInsuranceFrom + ", outcomeSumForInsuranceTo=" + outcomeSumForInsuranceTo + ", outcomeSumForEducationFrom=" + outcomeSumForEducationFrom + ", outcomeSumForEducationTo=" + outcomeSumForEducationTo + ", outcomeSumForBuildingFrom=" + outcomeSumForBuildingFrom + ", outcomeSumForBuildingTo=" + outcomeSumForBuildingTo + ", outcomeSumForIndividualBusinessFrom=" + outcomeSumForIndividualBusinessFrom + ", outcomeSumForIndividualBusinessTo=" + outcomeSumForIndividualBusinessTo + ", taxToPayFrom=" + taxToPayFrom + ", taxToPayTo=" + taxToPayTo + '}';
    }
}
